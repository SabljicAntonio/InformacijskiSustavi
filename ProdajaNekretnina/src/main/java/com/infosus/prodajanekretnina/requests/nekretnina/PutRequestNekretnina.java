...
public class PutRequestNekretnina {

    private String nazivNek;
    private String noviNazivNek;
    ...
    public String getNoviNazivNek() {
        return noviNazivNek;
    }

    public void setNoviNazivNek(String noviNazivNek) {
        this.noviNazivNek = noviNazivNek;
    }
    ...
    public boolean equals(Object o) {
        ...
        PutRequestNekretnina that = (PutRequestNekretnina) o;
        return Objects.equals(nazivNek, that.nazivNek) && Objects.equals(noviNazivNek, that.noviNazivNek) && Objects.equals(adresa, that.adresa) && Objects.equals(povrsina, that.povrsina) && Objects.equals(ocjena, that.ocjena) && Objects.equals(opis, that.opis) && Objects.equals(cijena, that.cijena) && Objects.equals(status, that.status) && Objects.equals(nazivAgenta, that.nazivAgenta) && Objects.equals(drzava, that.drzava) && Objects.equals(tipNek, that.tipNek);
    }

    @Override
    public int hashCode() {
        return Objects.hash(nazivNek, noviNazivNek, adresa, povrsina, ocjena, opis, cijena, status, nazivAgenta, drzava, tipNek);
    }

    @Override
    public String toString() {
        return "PutRequestNekretnina{" +
                "nazivNek='" + nazivNek + '\'' +
                ", noviNazivNek='" + noviNazivNek + '\'' +
                ", adresa='" + adresa + '\'' +
                ", povrsina=" + povrsina +
                ", ocjena=" + ocjena +
                ", opis='" + opis + '\'' +
